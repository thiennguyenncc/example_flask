...
/**
 * Class CancelledReApprovedNewFemaleTest
 * P_04_01
 * @package Api\Participation
 */
class CancelledReApprovedNewFemaleTest extends BaseParticipantTest
{
    public function setUp(): void
    {
        ...
        $this->given_a_cancelled_reapproved_female_logged_in_user();
        $this->monday = Carbon::now()->startOfWeek()->addHours(1);
        $this->given_dating_days();
    }

    private function given_a_cancelled_reapproved_female_logged_in_user()
    {
    ...
    private function then_expect_result_on_monday_tuesday_wednesday(TestResponse $response)
    {
        ...
        //- Wednesday this week will NOT show (expired)
        $this->assertEquals(ParticipationOpenExpireStatus::Expired, $weeks[0][0]['open_expiry_status']);

        //- I can NOT participate on Saturday, Sunday next next week (closed)
