...
class UsersMatchedRematching
{
    ...
    {
        $participants = $this->participantForRematchRepository->getParticipantsRematchingByStatusAndDate(ParticipantForRematchStatus::Matched, now());
