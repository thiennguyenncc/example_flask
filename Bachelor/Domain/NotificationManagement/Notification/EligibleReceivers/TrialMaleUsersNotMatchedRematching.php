...
class TrialMaleUsersNotMatchedRematching
{
    /**
    ...
    {
        $participants = $this->participantForRematchRepository->getParticipantsRematchingByStatusAndDate(ParticipantForRematchStatus::Unmatched, now(), true);
