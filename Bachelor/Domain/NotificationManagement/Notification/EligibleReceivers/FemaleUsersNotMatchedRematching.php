...
class FemaleUsersNotMatchedRematching
{
    /**
    ...
    {
        $participants = $this->participantForRematchRepository->getParticipantsRematchingByStatusAndDate(ParticipantForRematchStatus::Unmatched, now(), false, UserGender::Male);
