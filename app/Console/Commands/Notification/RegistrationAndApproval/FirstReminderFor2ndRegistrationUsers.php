...
class FirstReminderFor2ndRegistrationUsers extends AbstractNotificationSenderCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registraion-approval-notification:first-reminder-for-2nd-registration-users {gender}';
     ...
     * @var string
     */
    protected $description = 'Send notification to remind first time 2nd registration users';
    ...
    public function __construct(
        ...
        $this->eligibleReceiver->approvedDay = Carbon::yesterday();
    ...
    protected function getKey(): string
    {
        if ($this->getEligibleGender() == UserGender::Female) {
            return config('notification_keys.1st_reminder_for_2nd_registration_female');
        } elseif ($this->getEligibleGender() == UserGender::Male) {
            return config('notification_keys.1st_reminder_for_2nd_registration_male');
        }
